    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <h3>Quick Links</h3>
            <Link component="button" onClick={() => handleNavigation('home')}>
              Home
            </Link>
            <Link
              component="button"
            ...
            <Link component="button" onClick={() => handleNavigation('stocks')}>
              Stocks
            </Link>
            <Link component="button" onClick={() => handleNavigation('about')}>
              About
            </Link>
          </div>
