      ...
      <main className="grow">
        ...
        <section className="py-12 bg-gray-50" aria-labelledby="about-story">
          <div className="max-w-3xl mx-auto px-4 text-center">
            <h2 id="about-story" className="text-2xl font-semibold mb-4">
              {STORY.title}
            </h2>
                ...
                <Card key={t.id} className="text-center">
                  <CardContent>
                    <div className="flex flex-col items-center gap-3">
                      <Avatar className="bg-teal-400 text-white">
                        {getInitials(t.name)}
                      </Avatar>
        ...
        {/* Mission */}
        <section
          className="py-12 bg-teal-600 text-white"
          aria-labelledby="about-mission"
        >
          <div className="max-w-4xl mx-auto px-4 text-center">
            <h2 id="about-mission" className="text-2xl font-semibold mb-4">
              {MISSION.title}
            </h2>
